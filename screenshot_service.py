...
class ScreenshotService:
    ...
    async def capture_website(
        ...
        if not self.browser:
            raise RuntimeError(
                "ScreenshotService not initialized. Use as async context manager.")
    ...
    async def capture_with_scroll(
        ...
        try:
            ...
            output_path = Path("outputs/screenshots") / filename
    ...
    async def capture_with_mobile_view(self, url: str) -> tuple[str, str]:
        ...
        try:
            ...
            mobile_base64 = base64.b64encode(
                mobile_screenshot_bytes).decode('utf-8')
